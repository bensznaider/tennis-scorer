...
const ScoringFlow: React.FC<any> = () => {
  ...
  return (
    <div style={{textAlign:"center", marginLeft:"2%", marginRight:"2%", marginTop:"auto", marginBottom:"auto"}}>
      ...
      {!loading && flowStep === 1 && <NumberOfSets setFlowStep={setFlowStep} setSets={setSets} setLoading={setLoading}/>}
      ...
      {!loading && flowStep === 3 && <Score player1={player1} player2={player2} server={server} sets={sets} setLoading={setLoading}/>}
    </div>
  );
};
