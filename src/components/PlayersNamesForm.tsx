...
const PlayersNamesForm: React.FC<PlayersNamesProps> = ({
  player1,
  player2,
  setPlayer1,
  setPlayer2,
  ...
  const handleSubmitPlayersNames = (
  ...
  return (
    <div>
      ...
      <form
        ...
        onSubmit={handleSubmitPlayersNames}
      >
        Player 1
        <input
